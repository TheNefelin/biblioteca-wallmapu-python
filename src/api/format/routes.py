...
@router.get(
  "/pagination",
  response_model=ApiResponse[PaginationResponseDTO[list[FormatResponse]]],
...
@router.get(
  "/",
  response_model=ApiResponse[List[FormatResponse]],
  status_code=HTTP_200_OK,
...
@router.post(
  "/",
  response_model=ApiResponse[FormatResponse],
